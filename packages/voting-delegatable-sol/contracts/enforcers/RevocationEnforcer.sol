...
import { Transaction, SignedDelegation, Delegation } from "../TypesAndDecoders.sol";
    ...
    Delegatable("RevocationEnforcer", "1")
{
    ...
    function checkIsRevoked(SignedDelegation memory _signedDelegation) public view returns (bool revoked) {
        bytes32 delegationHash_ = GET_SIGNEDDELEGATION_PACKETHASH(_signedDelegation);
        return isRevoked[delegationHash_];
    }
